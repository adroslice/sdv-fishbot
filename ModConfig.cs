...
public sealed class ModConfig
{
    ...
    public void SetupConfigOptions(IGenericModConfigMenuApi configMenu, IManifest mod)
    {
        ...
        configMenu.AddKeybind(
            ...
            getValue: () => this.ToggleAutomationKey,
            setValue: value => this.ToggleAutomationKey = value
        );
        ...
        configMenu.AddBoolOption(
            mod: mod,
            name: () => "Auto-Cast",
            getValue: () => this.DoAutoCast,
            setValue: value => { this.DoAutoCast = value; }
        );
        configMenu.AddBoolOption(
            mod: mod,
            name: () => "Auto-Hit",
            getValue: () => this.DoAutoHit,
            setValue: value => { this.DoAutoHit = value; }
        );
        configMenu.AddBoolOption(
            mod: mod,
            name: () => "Auto-Play Minigame",
            getValue: () => this.DoAutoPlay,
            setValue: value => { this.DoAutoPlay = value; }
        );
        configMenu.AddBoolOption(
            mod: mod,
            name: () => "Auto-Stow Fish",
            getValue: () => this.DoAutoStow,
            setValue: value => { this.DoAutoStow = value; }
        );
        configMenu.AddBoolOption(
            mod: mod,
            name: () => "Auto-Loot Treasure",
            getValue: () => this.DoAutoLoot,
            setValue: value => { this.DoAutoLoot = value; }
        );

        configMenu.AddSectionTitle(mod: mod, text: () => "Utility", tooltip: () => "Little features to improve your fishing experience.");
        configMenu.AddBoolOption(
            mod: mod,
            getValue: () => this.EnableBubbleRadar,
            setValue: value => this.EnableBubbleRadar = value,
            name: () => "Bubble Radar",
        ...
        configMenu.AddNumberOption(
            ...
            setValue: value => this.FA_PredictLinearFrames = value,
            name: () => nameof(this.FA_PredictLinearFrames),
        ...
        configMenu.AddNumberOption(
            mod: mod,
            getValue: () => this.FA_RelativeOffsetBarPercentage,
        ...
        configMenu.AddNumberOption(
            mod: mod,
            getValue: () => this.FA_PrioTreasureAbove,
            setValue: value => this.FA_PrioTreasureAbove = value,
            name: () => nameof(this.FA_PrioTreasureAbove),
        ...
        configMenu.AddNumberOption(
            mod: mod,
            getValue: () => this.FA_PrioFishBelow,
            setValue: value => this.FA_PrioFishBelow = value,
            name: () => nameof(this.FA_PrioFishBelow),
        ...
        configMenu.AddNumberOption(
            mod: mod,
            getValue: () => this.FA_MinBarTargetVelocity,
            setValue: value => this.FA_MinBarTargetVelocity = value,
            name: () => nameof(this.FA_MinBarTargetVelocity),
        ...
        configMenu.AddNumberOption(
            mod: mod,
            getValue: () => this.FA_MaxBarVelocityNearBottom,
            setValue: value => this.FA_MaxBarVelocityNearBottom = value,
            name: () => nameof(this.FA_MaxBarVelocityNearBottom),
        ...
        configMenu.AddNumberOption(
            mod: mod,
            getValue: () => this.FA_MaxBarVelocity,
            setValue: value => this.FA_MaxBarVelocity = value,
            name: () => nameof(this.FA_MaxBarVelocity),
        ...
        configMenu.AddNumberOption(
            mod: mod,
            getValue: () => this.FA_BottomThreshold,
            setValue: value => this.FA_BottomThreshold = value,
            name: () => nameof(this.FA_BottomThreshold),
